...
# export FZF_DEFAULT_COMMAND='fd . ~ --type f --hidden --color always | sed "s=.*noibe/==g; s/\[1;34m/\[1;90m/g"'
export FZF_DEFAULT_COMMAND='fd . ~ --type f --hidden --color always | sed "s/\[1;34m/\[1;90m/g"'
